...
function sendMsg() {
  ...
  row.innerHTML = `<div class="msg-avatar" style="background:linear-gradient(135deg,#f59e0b,#d97706);">PM</div><div class="msg-group"><div class="bubble mine">${text.replace(/</g,'&lt;')}</div><div class="msg-meta">${time} <i class="fa-solid fa-check"></i></div></div>`;
